...
<div class = "header">
	<center> <h1> Sterge anvelope </h1> </center>
</div>
	...
	<?php
		...
		if(isset($_POST['Sterge']) && ($_POST['nume'] != NULL))
		{
			...
			{ 
				//echo "name not found\n<br><br>";
				echo "<center><b>Numele anvelopelor nu a fost gasit</b></center>";
			}
			else
			{
				$query_2 = "UPDATE Masini SET AnvelopeID = NULL WHERE AnvelopeID IN (SELECT AnvelopaID FROM Anvelope WHERE Nume = '{$nume}')"; 
				$result = sqlsrv_query($conn, $query_2);
				
				$query_delete = "DELETE FROM Anvelope WHERE Nume = '{$nume}'";
				$result = sqlsrv_query($conn, $query_delete);
				echo "<center><b> Anvelope eliminate! </b></center>";
				//echo "exista!";
			}
		}
		else if(isset($_POST['Sterge']) && ($_POST['nume'] == NULL))
		{
			echo "<center><b>Introduceti numele anvelopelor pe care doriti sa le eliminati<br><br></b></center>";
		}
